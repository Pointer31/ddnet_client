...
void CMenus::RenderStartMenu(CUIRect MainView)
{
	...
	if (IsServerRunning()) 
	{
		...
		if(DoButton_Menu(&s_LocalServerJoinButton, Localize("Join"), 0, &JoinButton, BUTTONFLAG_LEFT, nullptr, IGraphics::CORNER_ALL, Rounding, 0.5f, ColorRGBA(0.0f, 0.0f, 0.0f, 0.25f))) 
