...
image_infclass = Image("infclass", "infclass.png")
...
container.images.Add(image_infclass)
...
set_infclass = SpriteSet("infclass", image_infclass, 64, 32)
...
container.spritesets.Add(set_infclass)
...
container.sprites.Add(Sprite("inf_sniper_rifle", set_infclass, 0,0,10,2))
container.sprites.Add(Sprite("inf_scientist_laser", set_infclass, 0,4,20,4))
container.sprites.Add(Sprite("inf_medic_shotgun", set_infclass, 0,8,20,4))
container.sprites.Add(Sprite("inf_biologist_shotgun", set_infclass, 0,12,20,4))
container.sprites.Add(Sprite("inf_looper_laser", set_infclass, 0,16,20,4))
...
container.sprites.Add(Sprite("inf_biologist_mine", set_infclass, 20,12,6,4))
container.sprites.Add(Sprite("inf_mercenary_bomb", set_infclass, 20,16,4,4))
container.sprites.Add(Sprite("inf_white_hole", set_infclass, 20,20,24,4))
container.sprites.Add(Sprite("inf_turret_destruction", set_infclass, 20,24,4,4))
container.sprites.Add(Sprite("inf_turret_laser", set_infclass, 20,24,4,4))

container.sprites.Add(Sprite("inf_infection_hammer", set_infclass, 48,12,16,16))
...
container.sprites.Add(Sprite("inf_status_hookable", set_infclass, 48,20,4,4))
